...
import 'metaplayer_admin_model.dart';
export 'metaplayer_admin_model.dart';
...
/// }
///
class MetaplayerAdminWidget extends StatefulWidget {
  const MetaplayerAdminWidget({super.key});

  static String routeName = 'metaplayerAdmin';
  static String routePath = 'metaplayerAdmin';

  @override
  State<MetaplayerAdminWidget> createState() => _MetaplayerAdminWidgetState();
}

class _MetaplayerAdminWidgetState extends State<MetaplayerAdminWidget> {
  late MetaplayerAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MetaplayerAdminModel());
                                                    ...
                                                    Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            'Plano: Premium - Subdomínio: abc.metaplayer.com',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodySmall
                                                                .override(
                                                    ...
                                                    Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            'Plano: Básico - Subdomínio: xyz.metaplayer.com',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodySmall
                                                                .override(
                                                    ...
                                                    Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            'Plano: Enterprise - Subdomínio: tech.metaplayer.com',
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodySmall
                                                                .override(
